...
public class ClientServiceImpl implements ClientService {
	...
	public ClientDto getClientById(Long clientId) {
		Client client = clientRepository.findById(clientId)
				.orElseThrow(() -> new ClientNotFoundException("Client Does not Exist" + clientId));
	...
	public ClientDto updateClient(Long clientId, ClientDto updateClient) {
		...
		if (updateClient.getStatus() == null || updateClient.getStatus().isEmpty()) {
			client.setStatus("active"); // Default status
		} else {
	...
	public void deleteClient(Long clientId) {
		...
		Client client = clientRepository.findById(clientId)
				.orElseThrow(() -> new ClientNotFoundException("Client Does not Exist with given ID" + clientId));
